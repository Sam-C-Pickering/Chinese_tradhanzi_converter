...
Converter for simplified hanzi to traditional or vice versa.
Notation for Hanzi --- Pinyin & Zhuyin.
Allow users to upload a file of hanzi for conversion.
Allow users to download converted hanzi. 
Allow users to change between notation and conversion types.
provide a feature for users to directly input with a file via a GUI.
